...
# You are given a list of customer IDs, some of which are duplicated. Write a Python function to remove duplicates and display the unique customer IDs.
...
def remove_dupes(ids):
    #Turning list into set. Sets automatically get rid of dupes
    ids_set = set(ids)

    # This will print in random order because sets are unordered
    print(ids_set)

remove_dupes(customer_ids)
